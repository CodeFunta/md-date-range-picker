    ...
    function mdDateRangeDirective() {
        return {
            ...
            template: ['<md-menu ng-disabled="ngDisabled">',
                ...
                '  <span ng-if="ngModel.dateStart && ngModel.dateEnd">{{ngModel.dateStart | date}} - {{ngModel.dateEnd | date}}</span>',
                '  <span ng-if="!ngModel.dateStart || !ngModel.dateEnd">{{placeholder}}</span>',
